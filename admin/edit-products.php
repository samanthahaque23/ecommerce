...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" id="product_keyword" value="<?php echo $product_keywords ?>" name="product_keyword" class="form-control" required="required">
        </div>
...
<div class="form-outline w-50 m-auto mb-4">
    ...
    <select name="product_brands" class="form-select">
        ...
        <div class="w-50 m-auto mb-4">
            <input type="submit" id="edit_product" value="Update Product" name="edit_product" class="btn btn-outline-success" required="required">
        </div>
    </form>
</div>