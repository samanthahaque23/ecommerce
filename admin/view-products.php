    ...
    <tbody>
        ...
        ?>
            <tr class='text-center'>
                ...
                <td>
                    <img src='./product-images/<?php echo $product_image1 ?>' style='height:60px' alt='product-image'>
                </td>
                ...
                <td><a href='index.php?delete_products=<?php echo $product_id ?>'><i class='fa-solid fa-trash'></i></td>
            </tr>";
